...
# plt.imshow(results, aspect='auto', origin='lower', vmin = 0, vmax = 3e2, extent=[fmin, fmax, delay_min, delay_max], cmap = 'turbo')
...
# linewidth_max = 5
# ds = 0.25
# bound_shift = [[pt-ds, pt+ds] for pt in x0]
...
# plt.figure()
# plt.subplot(311)
# plt.plot(delay_axis, -shift[:,0]+0.5)
