...
filepath = "/Volumes/LAUDATE/Data/260100 - TR-TFP/Stimulations.h5"

wrp = Wrapper(filepath)

# print(wrp)

path = "Brillouin/2026-02-04/LED stimul 01"
...
# bound_linewidth = [[0, 2] for _ in x0]
...
# treat.combine_results_FSR(FSR=15, keep_max_amplitude=False, amplitude_weight=False, shift_err_weight=False, position=None)
